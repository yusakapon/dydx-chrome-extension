    ...
    <AppAccordion class="flex flex-col justify-center items-center px-2">
      ...
      <template v-slot:content>
        ...
        <div class="pb-4 pt-2 flex justify-between">
          <button
            @click="marketSell"
            class="bg-modal-container hover:bg-blue-700 active:bg-green-700 font-semibold py-3 px-6 border border-sell text-sell rounded"
          ...
          <button
            @click="marketBuy"
            class="bg-modal-container hover:bg-blue-700 active:bg-green-700 font-semibold py-3 px-6 border border-buy text-buy rounded"
